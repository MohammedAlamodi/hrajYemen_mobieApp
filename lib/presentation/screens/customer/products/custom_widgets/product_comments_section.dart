      ...
      child: Column(
        ...
        children: [
          ...
          if (isExpired) ...[
            ...
            const Center(
              child: CustomText(
                title: 'يرجى تسجيل الدخول لإضافة تعليق',
                color: Colors.grey,
                size: 12,
              ),
            ),
...
class _CommentItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    debugPrint('profileImageUrl: ${comment.user?.profileImageUrl}');
        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                CustomAvatarWidget(
                  imageUrl: comment.user?.profileImageUrl ?? EndPointsStrings.emptyImageUrl,
                  size: 40,
                ),
              ],
            ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // زر الإرسال
              InkWell(
                onTap: vm.commentCharCount < 0 ? null : () async {
                  await vm.addComment(context);
                }, // تعطيل الزر إذا كان هناك خطأ في العد
