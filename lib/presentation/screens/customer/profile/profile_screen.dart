...
import '../../common/auth/register/register_view.dart';
...
import 'settings/pay_commission.dart';
import 'settings/settings_screen.dart';
import 'settings/terms_and_policies_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _initData() async {
    debugPrint("------- Initializing Profile Screen Data...");
    await profileViewModel.initData();
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(child: _buildUserView(context)),
          ],
        ),
      ),
    );
  ...
  Widget _buildUserView(BuildContext context) {
    ...
    UserProfileModel? user = profileViewModel.userProfile;
            ...
            children: [
              Expanded(
                child: GestureDetector(
                  onTap: () {
                    MyAdViewModel vm = Provider.of<MyAdViewModel>(
                      context,
                      listen: false,
                    );
                    vm.changeTab(0);
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: _buildStatCard(
                    context: context,
                    count: user?.numberOfExpireProducts ?? 0,
    ...
    return Container(
      ...
      child: Row(
        children: [
          // الصورة
          CustomAvatarWidget(
            imageUrl: user?.profileImageUrl ?? EndPointsStrings.emptyImageUrl,
            size: 70,
          ),
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => RegisterScreen(
                    existingUserData: profileViewModel.userProfile,
                    isEditing: true,
                  ),
                ),
              );
