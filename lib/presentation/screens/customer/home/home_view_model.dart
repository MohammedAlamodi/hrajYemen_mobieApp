...
class HomeViewModel extends ChangeNotifier {
  ...
  Future<void> toggleCategory(int categoryId) async {
    ...
    if (_selectedCategoryId == categoryId) {
      ...
      _products = await _repo.fetchProducts(page: _currentPage, limit: _pageSize, categoryId: _selectedCategoryId, subCategoryId: _selectedSubCategoryId, search: sherTextCont.text);
  ...
  Future<void> getInitialData() async {
    ...
    try {
      ...
      final results = await Future.wait([
        _repo.fetchProducts(page: _currentPage, limit: _pageSize, categoryId: _selectedCategoryId, subCategoryId: _selectedSubCategoryId, search: sherTextCont.text),
  ...
  Future<void> loadMoreProducts() async {
    ...
    try {
      _currentPage++;
      final newProducts = await _repo.fetchProducts(page: _currentPage, limit: _pageSize, categoryId: _selectedCategoryId, subCategoryId: _selectedSubCategoryId, search: sherTextCont.text);
